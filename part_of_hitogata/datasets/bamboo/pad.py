...
class RandomExpand(BaseInternode):
    ...
    def __call__(self, data_dict):
        ...
        data_dict['image'] = pad_image(data_dict['image'], (left, top, right, bottom), self.fill, 'constant')
        ...
        if 'mask' in data_dict.keys():
            data_dict['mask'] = pad_mask(data_dict['mask'], (left, top, right, bottom), 'constant')
